...
<script src="<c:url value="/resources/common/js/main.js" />"></script>
  ...
  <style>
    ...
    #frm {width:980px; margin:60px auto;font-size:13px;}
    .row button{float:left;width:100px; height:36px;background: #0085a1;cursor:pointer;color:#fff;margin:0 1px;}
    .hit{float:right;}
					...
					<div class="mycontainer mycontainer-sc">
					  <div id="frm">					    
					    ...
					    <div class="row">
					      ...
					      <form:select class="col-2" path="boardCategoryVO.cid" disabled="true" style="Width:100%;">
					    ...
					    <div class="row">
					      <label class="col-1" path="bid" style="float:left;">작성자</label>
					      <p><span>${boardVO.bnickname }(${boardVO.bid })</span></p>
					    </div>
					    <div class="row">
					      <form:label class="col-1" path="bcontent" >내용</form:label>
					      <form:textarea class="col-2" rows="10" path="bcontent" readOnly="true" style="padding:0;height:400px;background:#fff;"></form:textarea>
